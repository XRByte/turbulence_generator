...
class TurbGen
{
    ...
    // ******************************************************
    public: virtual bool check_for_update(const double time, const std::vector<double> &v_turb) {
        // ******************************************************
    ...
    // ******************************************************
    public: bool write_to_evol_file(const double time, const double ampl_factor[], const std::vector<double> &v_turb) {
